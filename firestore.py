...
if refresh_circuits:
    ...
    GROUP BY 1"""
        ...
        rows = cur.fetchall()
        keys = [k[0] for k in cur.description]
        print(pd.DataFrame([dict(zip(keys, row)) for row in rows]),
              pd.DataFrame(schools_res))
...
## Players
if refresh_players is not False:
    ...
    if refresh_players is not True:
        player_slugs = refresh_players
...
if refresh_records:
    ...
    for en in res:
        ...
        en[
            "Team"
        ] = f"<a href = '../tournaments/{utils.string(en['tournament_id'])}/team-detail#{utils.slug(en['Team'])}'>{en['Team']}</a>"
    ...
    for en in res:
        en[
            "PP20TUH"
        ] = f"<a href = '../tournaments/{utils.string(en['tournament_id'])}/player-detail#{utils.slug(en['Player'])}-{utils.slug(en['Team'])}'>{en['PP20TUH']}</a>"
        if en["player_slug"]:
            en[
                "Player"
            ] = f"<a href = '../players/{en['player_slug']}'>{en['Player']}</a>"
    ...
    for en in res:
        en[
            "-5P20TUH"
        ] = f"<a href = '../tournaments/{utils.string(en['tournament_id'])}/player-detail#{utils.slug(en['Player'])}-{utils.slug(en['Team'])}'>{en['-5P20TUH']}</a>"
        if en["player_slug"]:
            en[
                "Player"
            ] = f"<a href = '../players/{en['player_slug']}'>{en['Player']}</a>"
    ...
    for en in res:
        en[
            "Pts"
        ] = f"<a href = '../tournaments/{utils.string(en['tournament_id'])}/player-detail#{utils.slug(en['Player'])}-{utils.slug(en['Team'])}'>{round(en['Pts'])}</a>"
        if en["player_slug"]:
            en[
                "Player"
            ] = f"<a href = '../players/{en['player_slug']}'>{en['Player']}</a>"
    ...
    for en in res:
        en[
            "Tossups"
        ] = f"<a href = '../tournaments/{utils.string(en['tournament_id'])}/player-detail#{utils.slug(en['Player'])}-{utils.slug(en['Team'])}'>{round(en['Tossups'])}</a>"
        if en["player_slug"]:
            en[
                "Player"
            ] = f"<a href = '../players/{en['player_slug']}'>{en['Player']}</a>"
    ...
    for en in res:
        en[
            "-5"
        ] = f"<a href = '../tournaments/{utils.string(en['tournament_id'])}/player-detail#{utils.slug(en['Player'])}-{utils.slug(en['Team'])}'>{round(en['-5'])}</a>"
        if en["player_slug"]:
            en[
                "Player"
            ] = f"<a href = '../players/{en['player_slug']}'>{en['Player']}</a>"
...
if refresh_sets:
    ...
    """)
        ...
        for team in teams_res:
            ...
            team['Team'] = f"<a href = '../tournaments/{str(team['tournament_id']).replace('.0', '')}/team-detail#{utils.slug(team['Team'])}'>{team['Team']}</a>"
    ...
    """)
        ...
        for player in players_res:
            ...
            player['Team'] = f"<a href = '../tournaments/{str(player['tournament_id']).replace('.0', '')}/player-detail#{utils.slug(player['Team'])}'>{player['Team']}</a>"
...
## Schools
if refresh_schools is not False:
    ...
    if refresh_schools is not True:
        team_slugs = refresh_schools
